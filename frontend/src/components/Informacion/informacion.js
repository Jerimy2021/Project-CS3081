...
function Informacion({isVisible, info, infoDivRef}) {
    ...
    return (
        <div className="informacion" ref={infoDivRef}>
            <div id="leftInformacion" className={isVisible ? "container slide-in-left" : "container slide-out-left"}>
            ...
            <div id="rightInformacion" className={isVisible ? "container slide-in-right" : "container slide-out-right"}>
